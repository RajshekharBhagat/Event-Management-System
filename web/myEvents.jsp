<%-- 
    Document   : myEvents
    Created on : 15 Sep, 2023, 11:25:21 PM
...
<html>
    ...
    <body>
                ...
                while (resultSet.next())
                    {
                        ...
                        %>
                        <form action="showParticipant.jsp" method="get">
                            <table border="1">
                                <tr>
                                    <th>Select</th>
                                    <th>Event Name</th>
        ...
        <%
                ...
                %>      <button name="showParticipant" value="show">Show Participants</button>
                        </form> 
                <%
